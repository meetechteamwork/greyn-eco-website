              ...
              <div className="absolute right-0 mt-2 w-56 rounded-lg bg-white shadow-xl border border-gray-200 py-2 z-50">
                ...
                <div className="py-1">
                  <button
                    onClick={() => {
                      setShowProfileDropdown(false);
                      router.push('/corporate/profile-settings');
                    }}
                    className="flex w-full items-center gap-3 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                  >
                    <svg
                  ...
                  <button
                    onClick={() => {
                      setShowProfileDropdown(false);
                      router.push('/corporate/profile-settings?tab=preferences');
                    }}
                    className="flex w-full items-center gap-3 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                  >
                    <svg
                  ...
                  <button
                    onClick={() => {
                      setShowProfileDropdown(false);
                      router.push('/corporate/help-support');
                    }}
                    className="flex w-full items-center gap-3 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                  >
                    <svg
