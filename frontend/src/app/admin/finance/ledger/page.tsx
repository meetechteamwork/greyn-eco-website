...
export default function FinanceLedgerPage() {
  ...
  useEffect(() => {
    const fetchLedger = async () => {
      try {
        ...
        // TODO: Implement api.admin.finance.ledger.getAll() when backend endpoint is ready
        // const response = await api.admin.finance.ledger.getAll();
  ...
  const allCreditEntries: CreditEntry[] = creditEntries;
