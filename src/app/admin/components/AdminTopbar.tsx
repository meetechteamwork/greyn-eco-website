...
export default function AdminTopbar() {
  ...
  // Mock notifications
  const notifications = [
    { id: 1, type: 'alert', message: 'New user registration requires approval', time: '2 min ago', unread: true },
    { id: 2, type: 'success', message: 'System backup completed successfully', time: '1 hour ago', unread: true },
    { id: 3, type: 'info', message: 'High transaction volume detected', time: '3 hours ago', unread: false },
    { id: 4, type: 'warning', message: 'API rate limit approaching threshold', time: '5 hours ago', unread: false },
  ];
        ...
        <div className="flex-1 max-w-2xl">
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2.5 border border-gray-300 dark:border-slate-600 rounded-xl bg-gray-50 dark:bg-slate-800 text-sm text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
            />
            {searchQuery && (
              <button
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {showProfileDropdown && (
              <div className="absolute right-0 mt-2 w-72 rounded-xl bg-white dark:bg-slate-800 shadow-2xl border border-gray-200 dark:border-slate-700 py-2 z-50">
                ...
                {/* Menu Items */}
                <div className="py-1">
                  <button className="flex w-full items-center gap-3 px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
                    <svg
                ...
                <div className="border-t border-gray-200 dark:border-slate-700 pt-1 mt-1">
                  <button className="flex w-full items-center gap-3 px-4 py-2.5 text-sm font-semibold text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors">
                    <svg
