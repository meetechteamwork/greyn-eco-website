...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 border-r border-slate-700/50 shadow-2xl flex flex-col">
      {/* Logo/Brand Section */}
      <div className="p-6 border-b border-slate-700/50 bg-gradient-to-r from-slate-800 to-slate-900">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="mt-0.5 text-xs text-slate-400 font-medium">Control Center</p>
          </div>
        </div>
      </div>
